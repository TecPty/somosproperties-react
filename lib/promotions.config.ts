...
export const SHARED_PROMOTIONS: Promotion[] = [
  ...
  //   type: 'shared',
  //   images: {
  //     desktop: '/images/properties/sunset-strip/flyers/modal-desktop.webp',
  //     mobile: '/images/properties/sunset-strip/flyers/modal-mobile.webp',
  //     thumbnail: '/images/properties/sunset-strip/flyers/modal-thumb.webp',
  //   },
  //   video: {
  //     desktop: '/videos/promotions/sunset-strip-desktop.mp4',
  //     mobile: '/videos/promotions/sunset-strip-mobile.mp4',
  //     poster: '/images/properties/sunset-strip/flyers/modal-thumb.webp',
  //     autoplay: true,
  //     loop: true,
  //     muted: true,
  //   },
...
export const PROPERTY_PROMOTIONS: Promotion[] = [
  {
    ...
    images: {
      desktop: '/images/properties/kings-park/promotional/modal-kings-park-desktop.webp',
      mobile: '/images/properties/kings-park/promotional/modal-kings-park-mobile.webp',
      thumbnail: '/images/properties/kings-park/promotional/thumbnail-kings-park.webp',
    },
  ...
  },
  {
    ...
    type: 'property-specific',
    images: {
      desktop: '/images/properties/balboa-boutique/promotional/modal-balboa-desktop.webp',
      mobile: '/images/properties/balboa-boutique/promotional/modal-balboa-mobile.webp',
      thumbnail: '/images/properties/balboa-boutique/promotional/thumbnail-balboa.webp',
    },
  ...
  },
  {
    ...
    type: 'property-specific',
    images: {
      desktop: '/images/properties/playa-escondida/promotional/modal-playa-desktop.webp',
      mobile: '/images/properties/playa-escondida/promotional/modal-playa-mobile.webp',
      thumbnail: '/images/properties/playa-escondida/promotional/thumbnail-playa.webp',
    },
