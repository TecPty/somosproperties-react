...
export const PROPERTY_PROMOTIONS: Promotion[] = [
  {
    ...
    images: {
      desktop: '/images/properties/kings-park/promotional/modal-desktop.png',
      mobile: '/images/properties/kings-park/promotional/modal-mobile.png',
      thumbnail: '/images/properties/kings-park/promotional/modal-thumb.png',
    },
  ...
  },
  {
    ...
    propertyId: 2, // ID real de Balboa Boutique
    title: 'Balboa Boutique: Vive en el centro',
    description: 'Promoción exclusiva en Balboa Boutique. Consulta condiciones.',
    type: 'property-specific',
    images: {
      desktop: '/images/properties/balboa-boutique/promotional/modal-desktop.png',
      mobile: '/images/properties/balboa-boutique/promotional/modal-mobile.png',
      thumbnail: '/images/properties/balboa-boutique/promotional/modal-thumb.png',
    },
  ...
  },
  {
    ...
    propertyId: 3, // ID real de Playa Escondida
    title: 'Playa Escondida: Oferta especial',
    description: 'Vive frente al mar con beneficios únicos. Consulta detalles.',
    type: 'property-specific',
    images: {
      desktop: '/images/properties/playa-escondida/promotional/modal-desktop.png',
      mobile: '/images/properties/playa-escondida/promotional/modal-mobile.png',
      thumbnail: '/images/properties/playa-escondida/promotional/modal-thumb.png',
    },
