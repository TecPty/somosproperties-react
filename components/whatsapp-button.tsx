...
export default function WhatsAppButton() {
  ...
  const handleWhatsAppClick = () => {
    ...
    const message = "Hola Lia, me interesa obtener más información sobre sus propiedades."
  ...
  return (
    <button
      ...
      className={`fixed bottom-6 left-6 z-50 flex items-center justify-center w-14 h-14 bg-[#25D366] text-white rounded-full shadow-lg hover:bg-[#20BA5A] hover:scale-110 transition-all duration-300 ${
        isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4 pointer-events-none"
      }`}
      aria-label="Contactar a Lia por WhatsApp"
    >
      <svg
