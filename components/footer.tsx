        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12">
          ...
          <div className="md:col-span-1 lg:col-span-2">
            ...
            <ul className="space-y-2">
              <li>
                <Link href={`/${locale}/premium`} className="hover:text-[#d4af37] transition-colors text-sm font-semibold">
                  {t('premium')}
                </Link>
              </li>
              <li>
                <Link href={`/${locale}/residenciales`} className="hover:text-[#3898EC] transition-colors text-sm">
                  {t('residential')}
                </Link>
              </li>
              <li>
                <Link href={`/${locale}/comerciales`} className="hover:text-[#3898EC] transition-colors text-sm">
                  {t('commercial')}
                </Link>
              </li>
            </ul>
          ...
          <div className="md:col-span-1 lg:col-span-2">
            ...
            <ul className="space-y-2">
              <li>
                <Link href={`/${locale}/nosotros`} className="hover:text-[#3898EC] transition-colors text-sm">
                  {t('aboutUs')}
                </Link>
              </li>
              <li>
                <Link href={`/${locale}/contacto`} className="hover:text-[#3898EC] transition-colors text-sm">
                  {t('contact')}
                </Link>
              </li>
            </ul>
          ...
          <div className="md:col-span-1 lg:col-span-2">
            ...
            <ul className="space-y-2">
              <li>
                <Link href={`/${locale}/privacidad`} className="hover:text-[#3898EC] transition-colors text-sm">
                  {t('privacy')}
                </Link>
              </li>
              <li>
                <Link href={`/${locale}/terminos`} className="hover:text-[#3898EC] transition-colors text-sm">
                  {t('terms')}
                </Link>
              </li>
              <li>
                <Link href={`/${locale}/politica-cookies`} className="hover:text-[#3898EC] transition-colors text-sm">
                  {t('cookiePolicy')}
                </Link>
              </li>
              <li>
                <Link href={`/${locale}/preferencias-cookies`} className="hover:text-[#3898EC] transition-colors text-sm">
                  {t('cookiePreferences')}
                </Link>
              </li>
            </ul>
