        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed">
              Tu socio de confianza en bienes raíces en Panamá. Más de 15 años ayudando a encontrar la propiedad
              perfecta.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-2 text-sm">
                ...
                <span>ventas@somosproperties.com</span>
              </li>
              <li className="flex items-start gap-2 text-sm">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <span>Calle 50, Edificio Tower Financial Center, Piso 15, Ciudad de Panamá</span>
              </li>
            </ul>
